...
//  private val pmhHelper = PoisonedMessageHandlerHelper[Task, RepublishStrategyTest](redactPayload = false)
...
//    val base =
//      new ConsumerBase[Task, Bytes]("test", "queueName", false, TestBase.testBlocker, ImplicitContextLogger.createLogger)
//
